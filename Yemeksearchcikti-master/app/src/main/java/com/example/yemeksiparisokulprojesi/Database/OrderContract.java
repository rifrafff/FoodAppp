...
public class OrderContract {
    ...
    public static abstract class OrderEntry implements BaseColumns{
        ...
        public static final String COLUMN_SECENEK1 = "secenek1";
        public static final String COLUMN_SECENEK2 = "secenek2";

        public static final String kullaniciAdi = "kullaniciAdi";
